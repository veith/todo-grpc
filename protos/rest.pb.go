...
func (Link_Method) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rest_154dc36e56dc6fed, []int{0, 0}
}
...
func (*Link) Descriptor() ([]byte, []int) {
	return fileDescriptor_rest_154dc36e56dc6fed, []int{0}
}
...
type Hateoas struct {
	Link                 []*Hateoas `protobuf:"bytes,1,rep,name=Link" json:"Link,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
func (*Hateoas) Descriptor() ([]byte, []int) {
	return fileDescriptor_rest_154dc36e56dc6fed, []int{1}
}
...
func (m *Hateoas) GetLink() []*Hateoas {
	if m != nil {
		return m.Link
	}
	return nil
...
func (m *Link) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Name) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintRest(dAtA, i, uint64(len(m.Name)))
...
func init() { proto.RegisterFile("protos/rest.proto", fileDescriptor_rest_154dc36e56dc6fed) }

var fileDescriptor_rest_154dc36e56dc6fed = []byte{
	// 272 bytes of a gzipped FileDescriptorProto
	,
}

...
func (*Todo) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_dee01add4f90eff3, []int{0}
}
...
func (*CreateTodoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_dee01add4f90eff3, []int{1}
}
...
func (*CreateTodoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_dee01add4f90eff3, []int{2}
}
...
func (*GetTodoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_dee01add4f90eff3, []int{3}
}
...
func (*GetTodoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_dee01add4f90eff3, []int{4}
}
...
func (*ListTodoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_dee01add4f90eff3, []int{5}
}
...
func (*ListTodoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_dee01add4f90eff3, []int{6}
}
...
func (*DeleteTodoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_dee01add4f90eff3, []int{7}
}
...
func (*DeleteTodoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_dee01add4f90eff3, []int{8}
}
...
func (*UpdateTodoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_dee01add4f90eff3, []int{9}
}
...
func (*UpdateTodoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_dee01add4f90eff3, []int{10}
}
...
func init() { proto.RegisterFile("protos/todo.proto", fileDescriptor_todo_dee01add4f90eff3) }

var fileDescriptor_todo_dee01add4f90eff3 = []byte{
	// 659 bytes of a gzipped FileDescriptorProto
	,
}

...
func (Link_Method) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_rest_abf8f3d4bb304fba, []int{0, 0}
}
...
func (*Link) Descriptor() ([]byte, []int) {
	return fileDescriptor_rest_abf8f3d4bb304fba, []int{0}
}
...
func init() { proto.RegisterFile("task-api/rest.proto", fileDescriptor_rest_abf8f3d4bb304fba) }

var fileDescriptor_rest_abf8f3d4bb304fba = []byte{
